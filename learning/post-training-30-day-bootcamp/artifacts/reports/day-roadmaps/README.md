...
- Day 05：[Lifecycle PNG](../day05-training-lifecycle-roadmap.png) · [Lifecycle SVG](../day05-training-lifecycle-roadmap.svg) · [MoE Anatomy PNG](../day05-moe-transformer-forward-backward-anatomy.png) · [MoE Anatomy SVG](../day05-moe-transformer-forward-backward-anatomy.svg)——主图覆盖数据边界、forward/backward、optimizer/checkpoint 与框架职责；新增 Anatomy 图以 Qwen3-30B-A3B 展开完整 MoE Transformer、每层 GQA/router/expert 矩阵、临时张量、反向梯度与 activation-checkpoint lifetime。
