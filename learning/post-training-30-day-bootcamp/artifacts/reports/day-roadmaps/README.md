...
- [`day-06-posttraining-scaling-decision-roadmap.svg`](./day-06-posttraining-scaling-decision-roadmap.svg)：把 SFT、DPO、RLVR 的阶段价值与 memory、compute、time/cost feasibility、扩展和停止证据放进同一张决策图。
